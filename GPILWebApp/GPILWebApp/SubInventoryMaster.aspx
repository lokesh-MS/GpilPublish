<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="SubInventoryMaster.aspx.cs" Inherits="GPILWebApp.SubInventoryMaster" %>
                    ...
                    <div class="card-body">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <div class="widget-main">
                                            <div class="col-md-12 mb-12">
                                                ...
                                                <asp:GridView ID="gvSubinv" runat="server" class="table table-success table-bordered"
                                                    OnPageIndexChanging="gvSubinv_PageIndexChanging"
                                                    OnRowCancelingEdit="gvSubinv_RowCancelingEdit"
                                                    OnRowCommand="gvSubinv_RowCommand"
                                                    OnRowUpdating="gvSubinv_RowUpdating" PageSize="10"
                                                    Width="90%" ForeColor="Black"
                                                    OnRowDataBound="gvSubinv_RowDataBound" AllowSorting="True" ShowFooter="True" EmptyDataText="No Data Found" AutoGenerateColumns="False" OnRowDeleting="gvSubinv_RowDeleting" OnRowEditing="gvSubinv_RowEditing">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Subinventory Code" SortExpression="SUB_INV_CODE">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lSubinventoryCode" ItemStyle-ForeColor="#ff0000" runat="server" Text='<%# Eval("SUB_INV_CODE") %>' />
                                                            </ItemTemplate>
                                                            <FooterTemplate>
                                                                ...
                                                                <asp:RequiredFieldValidator ID="reqSubinventoryCode" runat="server"
                                                                    ControlToValidate="lSubinventoryCode" ErrorMessage="*"
                                                                    ValidationGroup="ValgrpCust"></asp:RequiredFieldValidator>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Subinventory Description" SortExpression="SUB_INV_DESC">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lSubinventoryDescription" runat="server" CssClass="form-control border border-primary" Text='<%# Eval("SUB_INV_DESC") %>' />
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                                <asp:TextBox ID="txtSubinventoryDescription" runat="server" CssClass="form-control border border-primary" Text='<%#Eval("SUB_INV_DESC") %>'></asp:TextBox>
                                                            </EditItemTemplate>
                                                            <FooterTemplate>
                                                                <asp:TextBox ID="txtAddSubinventoryDescription" runat="server" CssClass="form-control border border-primary"></asp:TextBox>
                                                                <asp:RequiredFieldValidator ID="reqSubinventoryDescription" runat="server"
                                                                    ControlToValidate="txtAddSubinventoryDescription" ErrorMessage="*"
                                                                    ValidationGroup="ValgrpCust"></asp:RequiredFieldValidator>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                        ...
                        <div class="row" runat="server" id="idManual" visible="false">
                            <div class="widget-body">
                                <div class="widget-main">
                                    <div class="col-md-3 mb-3">
                                        <label class="control-label" style="color: #555555">* Sub Inventory Code</label>
                                        <asp:TextBox ID="txtSubInventoryCode" runat="server" CssClass="form-control border border-primary" required=''></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvSubInventoryCode" Display="Dynamic" runat="server" ForeColor="Red" ValidationGroup="id1" ControlToValidate="txtSubInventoryCode" />


                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-floating mb-3">
                                            <label class="control-label" style="color: #555555">* Sub Inventory Desc</label>
                                            <asp:TextBox ID="txtSubInventoryDesc" CssClass="form-control border border-primary" runat="server" required=''></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="rfvSubInventoryDesc" Display="Dynamic" runat="server" ForeColor="Red" ValidationGroup="id1" ControlToValidate="txtSubInventoryDesc" />
                                        </div>
                                    </div>
