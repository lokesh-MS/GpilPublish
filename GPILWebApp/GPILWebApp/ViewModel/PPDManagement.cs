    ...
    public class PPDManagement : GPIObject
    {
        ...
        public DataTable GetBatchNumber(string strFromDate,string strTodate,string strCrop,string strVariety,string strOrgnCode)
        {
            ...
            try
            {
                ...
                strQry = strQry + "  h.ORGN_CODE='" + strOrgnCode + "' and SUBSTRING(d.GPIL_BALE_NUMBER,1,2)='" + strCrop  + "' ";
                strQry = strQry + "  and SUBSTRING(d.GPIL_BALE_NUMBER,3,2)='" + strVariety + "' and h.CLASSIFICATION_DATE ";
        ...
        public DataSet GetBuyerVSClassReport(string strFromDate, string strToDate,string strCrop,string strVariety,string strOrgnCode)
        {
            ...
            try
            {
                if (strOrgnCode == "0")
                {
                    ...
                    strSQL = strSQL + " AND H.CLASSIFICATION_DATE BETWEEN CONVERT(datetime,'" + strFromDate + " 00:00:00 AM',105) ";
                    strSQL = strSQL + " and CONVERT(datetime,'" + strToDate + " 23:59:59 PM',105)  GROUP BY D.ISSUED_GRADE, ";
                ...
                else
                {
                    ...
                    strSQL = strSQL + "  CONVERT(datetime,'" + strFromDate + " 00:00:00 AM',105) and ";
                    strSQL = strSQL + "  CONVERT(datetime,'" + strToDate + " 23:59:59 PM',105)  GROUP BY ";
