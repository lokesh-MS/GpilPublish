...
{
    public class FactoryDispatchLoader
    {
        //select SHIPMENT_NO, SENDER_ORG_CODE, RECEIVER_ORG_CODE, SEND_BY, SENDER_TRUCK_NO, LR_NO, DRIVER_NAME, DRIVING_LICENCE_NO,
        //    TRANSPORT_CODE, FRIEGHT_CHARGES, CASE_NUMBER, GRADE, LR_DATE, DISPATCH_TYPE, AWB_NO, IS_LP5_NOTE, REMARKS,'V' AS INS_STS from[Sheet1$]
    ...
    public class ListFactoryDispatch
    {
        public List<FactoryDispatchLoader> FactoryDispatchs { get; set; }
    }
}