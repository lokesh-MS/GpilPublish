<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="WeightLossReport.aspx.cs" Inherits="GPILWebApp.WeightLossReport" %>
    ...
    <div class="page-content" style="background-color: white">
        ...
        <div class="row mb-0">
            <div class="col-sm-4">
             ...
             <div class="col-sm-4">
                <div class="form-sm-3">
                    <label class="control-label">Select Orgn Type </label>
                    <div>
                        <asp:DropDownList runat="server" CssClass="form-control" ID="ddlOrgnType"></asp:DropDownList>
                    </div>
                </div>
            </div>
