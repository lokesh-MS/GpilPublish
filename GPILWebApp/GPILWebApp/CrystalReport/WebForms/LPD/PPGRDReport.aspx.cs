    ...
    public partial class PPGRDReport : System.Web.UI.Page
    {
        ...
        public void rptView()
        {
            ...
            try
            {
                ...
                sql = sql + " and H.CROP='" + cbxcrop.Text + "' AND H.VARIETY='" + cbxvariety.Text + "' AND D.STATUS='Y' AND D.HEADER_ID=H.HEADER_ID AND CONVERT(varchar,H.DATE_OF_PURCH,105) BETWEEN CONVERT(varchar,'" + txt_From_Date.Text + "',105) AND CONVERT(varchar,'" + txt_To_Date.Text + "',105) GROUP BY H.ORGN_CODE+'-'+O.ORGN_NAME,P.PPG,H.CROP+'-'+C.CROP_YEAR,H.VARIETY+'-'+V.VARIETY_NAME ORDER BY P.PPG DESC";
