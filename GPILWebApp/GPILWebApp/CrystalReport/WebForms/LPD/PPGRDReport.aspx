<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="PPGRDReport.aspx.cs" Inherits="GPILWebApp.PPGRDReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="header">
        <h2 style="text-align: center; font-weight: bold; font-family: 'Times New Roman'; color: #438EB9">PPGRD Report </h2>
    </div>
    ...
    <div class="page-content" style="background-color: white">
        ...
        <div class="row">
          ...
          <h4 class="header green">PPGRD Report</h4>
