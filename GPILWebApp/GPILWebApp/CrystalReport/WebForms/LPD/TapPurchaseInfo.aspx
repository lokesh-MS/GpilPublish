<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="TapPurchaseInfo.aspx.cs" Inherits="GPILWebApp.TapPurchaseInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="header">
        <h2 style="text-align: center; font-weight: bold; font-family: 'Times New Roman'; color: #438EB9">TAP Invoice Values</h2>
    </div>
    <div class="page-content" style="background-color: white">
        ...
        <div class="col-sm-12 mb-0" style="width: 100%">
            <CR:CrystalReportViewer ID="TAPMonthEndValuesGST" runat="server" AutoDataBind="true" ToolPanelView="None" HasCrystalLogo="False" />
        ...
        <div class="col-sm-12 mb-0" style="width: 100%">
            <CR:CrystalReportViewer ID="TAPMonthEndValues" runat="server" AutoDataBind="true" ToolPanelView="None" HasCrystalLogo="False" />
            <CR:CrystalReportSource ID="CrystalReportSource2" runat="server">
            </CR:CrystalReportSource>
        </div>

        <div class="col-sm-12 mb-0" style="width: 100%">
            <CR:CrystalReportViewer ID="TAPInvoiceValuesGST" runat="server" AutoDataBind="true" ToolPanelView="None" HasCrystalLogo="False" />
            <CR:CrystalReportSource ID="CrystalReportSource3" runat="server">
            </CR:CrystalReportSource>
        </div>
        <div class="col-sm-12 mb-0" style="width: 100%">
            <CR:CrystalReportViewer ID="TAPInvoiceValuesReport" runat="server" AutoDataBind="true" ToolPanelView="None" HasCrystalLogo="False" />
            <CR:CrystalReportSource ID="TAPInvoiceValues" runat="server">
            </CR:CrystalReportSource>
        </div>
