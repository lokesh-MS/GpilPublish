<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ScrapMoistureReport.aspx.cs" Inherits="GPILWebApp.CrystalReport.WebForms.GLT.ScrapMoistureReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="header">
        <h2 style="text-align: center; fontD: \Saravanan\Ongole\17.07.22\GPILWebApp\GPILWebApp\CrystalReport\WebForms\GLT\ScrapMoistureReport.aspx-weight: bold; font-family: 'Times New Roman'; color: #438EB9">Scrap Moisture Report</h2>
    </div>
