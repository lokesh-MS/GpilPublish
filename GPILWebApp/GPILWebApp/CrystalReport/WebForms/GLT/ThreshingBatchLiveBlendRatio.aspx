...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-sm-4">
         ...
         <div class="col-sm-4">
        <asp:RadioButton ID="rdbIssueBlendRatio" runat="server" Text="Issue Blend Ratio" AutoPostBack="true" />
        <asp:RadioButton ID="rdbOutTurnBlendRatio" runat="server" Text="Out Turn Blend Ratio" AutoPostBack="true" />
             </div>
        <div class="col-sm-4">
            </div>
