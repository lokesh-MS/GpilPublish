...
namespace GPILWebApp.Models
{
    ...
    public partial class GPIL_CLASSIFICATION_DTLS_TEMP
    {
        ...
        public Nullable<double> WEIGHT_BEFORE_CLASSIFY { get; set; }
        public Nullable<double> WEIGHT_AFTER_CLASSIFICATION { get; set; }
        ...
        public virtual GPIL_CLASSIFICATION_HDR_TEMP GPIL_CLASSIFICATION_HDR_TEMP { get; set; }
