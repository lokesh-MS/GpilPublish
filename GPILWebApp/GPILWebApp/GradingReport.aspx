                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    <div class="col-md-2 mb-2">
                                        <asp:Button ID="btnViewReport" runat="server" Text="View" CssClass="btn btn-info rounded-pill px-4 mt-3" OnClick="btnViewReport_Click" />
                                       <asp:Button ID="btnCancel" runat="server" Text="Clear" CssClass="btn btn-info rounded-pill px-4 mt-3" OnClick="btnCancel_Click" />
