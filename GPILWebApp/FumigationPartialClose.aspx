<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeFile="FumigationPartialClose.aspx.cs" Inherits="GPILWebApp.FumigationPartialClose" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-header">
        <h1 style="font-weight: bold; font-family: Cambria;">Fumigation Partial Close</h1>
    </div>
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    <div class="col-md-3 mb-3">
                                        <asp:Label ID="lblFumigationLocation" runat="server" Text="Fumigation Location"></asp:Label>
                                        <asp:DropDownList ID="ddlFumigationLocation" runat="server" class="form-control" />
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <asp:Label ID="lblFumigationBatch" runat="server" Text="Fumigation Batch"></asp:Label>
                                        <asp:DropDownList ID="ddlFumigationBatch" runat="server" class="form-control" />
                                    </div>
                                </div>
                            </div>
                        </div>
