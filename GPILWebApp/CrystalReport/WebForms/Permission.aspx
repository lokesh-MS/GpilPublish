                  ...
                  <tr>
                    ...
                    <td align="right" style="width:35px; color:Black; font-family:Verdana;" >
                        <asp:ImageButton ID="btnRGPSearch" runat="server" 
                            ImageUrl="~/Images/Search.jpg" onclick="btnRGPSearch_Click" Width="35px" /></td>
                  </tr>
                </table>
            </td>
 ...
 <%--   <tr>
    ...
    <td colspan="2" style="height:auto;">
     ...
     <tr> 
       ...
       <td style="height:25px; padding-top:10px; padding-bottom:2px">       
           <asp:ImageButton ID="btnSave" runat="server" onclick="btnSave_Click"   Width="65px" 
             ImageUrl="~/images/Save.jpg" />
         <asp:ImageButton ID="btnClear" runat="server" OnClick="btnClear_Click"  Width="65px" 
             ImageUrl="~/images/Clear.jpg" />
         <asp:ImageButton ID="btnBack" runat="server" OnClick="btnBack_Click"   Width="65px" 
    ...
    <div style="background-color:white">
      ...
      <tr>
          ...
          <td align="center" > 
              <asp:ImageButton ID="btnFetch" runat="server" Width="100px" OnClick="btnFetch_Click" ImageUrl="~/images/View.jpg" />
          </td>
      </tr>
      <tr>
