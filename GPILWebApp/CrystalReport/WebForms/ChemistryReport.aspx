...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-sm-3-md-4">
                ...
                <div class="form-control-sm">
                    <asp:TextBox ID="txt_Report_Date0" runat="server" class="form-control" TextMode="Date">                            
                    </asp:TextBox>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-sm-3-md-4">
                ...
                <div>
                    <asp:DropDownList runat="server" CssClass="form-control" ID="ddCrop" AutoPostBack="true">
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-sm-3-md-4">
                ...
                <div>
                    <asp:DropDownList runat="server" CssClass="form-control" ID="ddGrade" AutoPostBack="true">
        ...
        <div class="col-sm-4">
            <div class="form-sm-3-md-4">
                ...
                <div>
                    <asp:DropDownList runat="server" CssClass="form-control" ID="ddVariety" AutoPostBack="true">
    ...
    <div class="col-sm-12 mb-0" style="width: 100%">
        <table>
            ...
            <center>
            <asp:Button ID="btnexportexcel" Text="Export Excel" runat="server" CssClass="btn btn-sm btn-success" OnClick="btnexportexcel_Click" />
            </center>
