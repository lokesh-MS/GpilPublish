...
<%--        <asp:RadioButton ID="rdbThreshingIssueDetails" runat="server" Text="Threshing Issue Details" AutoPostBack="true"  />
        <asp:RadioButton ID="rdbProcessChart" runat="server" Text="Process Chart" AutoPostBack="true" />--%>
               ...
               <asp:RadioButton runat="server" ID="rdbThreshingIssueDetails" GroupName="rdbrpttyp1" Text="Threshing Issue Details" ForeColor="Black" Checked="true" />
              <asp:RadioButton runat="server" ID="rdbProcessChart" GroupName="rdbrpttyp1" Text="Without Freight" ForeColor="Black" />
     ...
     <div class="row">
            <div class="col-sm-3">
                ...
                <div class="form-control-sm">
                    ...
                    <asp:Button ID="btnClose" runat="server" CssClass="btn btn-sm btn-danger" Text="Clear" OnClick="btnClose_Click1" />

                      <%-- <asp:Button ID="btnClose" runat="server" Text="Close" OnClientClick="return closeWindow();" OnClick="btnClose_Click1" />--%>
