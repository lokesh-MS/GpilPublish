...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="header">
        <h2 style="text-align: center; font-weight: bold; font-family: 'Times New Roman'; color: #438EB9"> Farmer Purchase Verification Slip By Date</h2>
    </div>
    ...
    <div class="page-content" style="background-color: white">
        ...
        <div class="form-control-sm "style="margin-top:10px" >
