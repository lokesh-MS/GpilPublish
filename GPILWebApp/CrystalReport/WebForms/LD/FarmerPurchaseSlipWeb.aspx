...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-3">
<%--            <label class="control-label"></label>
            <asp:Button ID="btnSave" runat="server" CssClass="btn-sm btn-success" Text="View" OnClick="btnClear_Click" />--%>
            <label class="control-label"></label>
<asp:Button ID="btnClear" runat="server" CssClass="btn btn-sm btn-danger" Text="Clear" OnClick="btnClear_Click1" />
