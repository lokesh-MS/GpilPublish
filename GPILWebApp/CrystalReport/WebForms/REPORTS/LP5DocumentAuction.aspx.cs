...
{
    public partial class LP5DocumentAuction : System.Web.UI.Page
    {
        ...
        public void viewoprpt()
        {
            ...
            try
            {
               // CrystalReportViewer1.Visible = false;
                ...
                {
                    dsLP5 = rptMgt.AuctionGetLP5Details(ddlShipmentNumber.SelectedItem.Value);
                    ...
                    LP5.Load(Server.MapPath("~/CrystalReport/rptLP5_Auction.rpt"));
