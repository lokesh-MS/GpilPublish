<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="LotWiseStock.aspx.cs" Inherits="GPILWebApp.CrystalReport.WebForms.LotWiseStock" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="header">
        <h2 style="text-align: center; font-weight: bold; font-family: 'Times New Roman'; color: #438EB9">Bale Wise Stock</h2>
    </div>
      ...
      <div class="row">
        <div class="col-sm-4">
         ...
         <div class="col-sm-4">
        <asp:RadioButton ID="rdbTapStock" runat="server" Text="TAP Stock" OnCheckedChanged="rdbTapStock_CheckedChanged" AutoPostBack="true" GroupName="LotWise" Checked="true"/>
        <asp:RadioButton ID="rdbOtherStock" runat="server" Text="Other Stock" OnCheckedChanged="rdbOtherStock_CheckedChanged" AutoPostBack="true" GroupName="LotWise" />
             </div>
        <div class="col-sm-4">
            </div>
