<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="BaleWeighLossRpt.aspx.cs" Inherits="GPILWebApp.CrystalReport.WebForms.REPORTS.BaleWeighLossRpt" %>
      ...
      <div class="page-content" style="background-color: white">
        ...
        <div class="row">
            <div class="col-sm-3">
                ...
                <div class="form-control-sm">
                    <asp:Button ID="btnview" runat="server" CssClass="btn btn-sm btn-success" Text="View Report" OnClick="btn_View_Click" />
        ...
        <div class="col-sm-12 mb-0" style="width: 100%">
            <CR:CrystalReportViewer ID="rdlcWeightLossReport" runat="server" AutoDataBind="true" ToolPanelView="None" HasCrystalLogo="False" />
