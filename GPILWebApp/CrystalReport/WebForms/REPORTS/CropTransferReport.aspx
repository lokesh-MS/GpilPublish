<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="CropTransferReport.aspx.cs" Inherits="GPILWebApp.CropTransferReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <h4 class="header green">Crop Transfer Report</h4>
          <hr />
        <div class="col-sm-12 mb-0" style="width: 100%">
            <CR:CrystalReportViewer ID="rdlcCropTransfer" runat="server" AutoDataBind="true" ToolPanelView="None" HasCrystalLogo="False" />
