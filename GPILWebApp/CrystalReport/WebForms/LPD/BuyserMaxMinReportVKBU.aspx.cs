...
namespace GPILWebApp.CrystalReport.WebForms.LPD
{
    public partial class BuyserMaxMinReportVKBU : System.Web.UI.Page
    {
        ...
        public bool validated()
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "err_msg", "alert('Select Orgn Name');", true);
                cbxcrop.Focus();
                return false;
            }
