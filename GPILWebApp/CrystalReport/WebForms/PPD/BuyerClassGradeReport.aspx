<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="BuyerClassGradeReport.aspx.cs" Inherits="GPILWebApp.BuyerClassGradeReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="header">
        <h2 style="text-align: center; font-weight: bold; font-family: 'Times New Roman'; color: #438EB9">Buyer Vs Classifier Grade Report</h2>
    </div>
        ...
        <div class="row">
            <div class="col-sm-3">
                ...
                <div class="form-control-sm">
                    ...
                    <asp:Button ID="btnCancel" runat="server" CssClass="btn btn-sm btn-danger" Text="Clear" OnClick="btnCancel_Click" />
